package dev.xernas.glowstone.server.config;
...
public class ConfigManager {
    ...
    private void setConfigDefaults() throws IOException {
        ...
        defaultProps.setProperty("version_name", "Glowstone 1.20.1");
    ...
    private void setMotdDefaults() throws IOException {
        ...
        motd.addComponent(a);
        Component glowstone = new TextComponent(" Glowstone");
        glowstone.setBold(true);
        glowstone.setColor(Color.GOLD);
        motd.addComponent(glowstone);
